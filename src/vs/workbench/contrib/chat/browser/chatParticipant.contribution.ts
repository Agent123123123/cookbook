...
import { AgentModeCompactChatViewPane } from '../../agentMode/browser/agentModeCompactChatViewPane.js';
...
const chatViewDescriptor: IViewDescriptor = {
	...
	canMoveView: true,
	ctorDescriptor: new SyncDescriptor(AgentModeCompactChatViewPane),
	when: ContextKeyExpr.and(
		...
		WorkbenchAgentModeContext.negate()
	)
};
