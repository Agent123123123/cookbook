...
export const OPTIONS: OptionDescriptions<Required<NativeParsedArgs>> = {
	...
	'agent-mode': { type: 'boolean', cat: 'o', description: localize('agentMode', "Opens the window directly in Agent Mode.") },
	'sessions': { type: 'boolean', cat: 'o', description: localize('sessions', "Opens the window in Agent Mode.") },
